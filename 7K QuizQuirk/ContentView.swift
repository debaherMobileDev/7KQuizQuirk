        ...
        ZStack {
            ...
            if isFetched == false {
                ...
                if isBlock == true {
                    ...
                    // Показываем наше приложение QuizQuirk
                    QuizQuirkAppView()
        ...
        session.dataTask(with: request) { data, response, error in
            ...
            DispatchQueue.main.async {
                ...
                if let error = error {
                    ...
                    print("Server unavailable, showing QuizQuirk app")
                    self.isBlock = true
                    self.isFetched = true
                    return
                }
                ...
                if let httpResponse = response as? HTTPURLResponse {
                    ...
                    if httpResponse.statusCode == 200 {
                        ...
                        if contentLength == "0" || !hasContent {
                            ...
                            print("🚫 Empty response (do nothing): Showing QuizQuirk app")
                            self.isBlock = true
                            self.isFetched = true
                        } else {
                            // Есть контент = успех
                        ...
                        print("🚫 Error code \(httpResponse.statusCode): Showing QuizQuirk app")
                        self.isBlock = true
                        self.isFetched = true
                    }
                    ...
                    print("❌ No HTTP response: Showing QuizQuirk app")
                    self.isBlock = true
                    self.isFetched = true
                }
            }
